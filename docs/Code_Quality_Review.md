...
- [ ] **4.1** `lib/core/utils/message_helper.dart`
  - 状态：⏳ 待检查
  - 问题数：-
  - 优先级：-
...
3. ⏳ app_theme.dart：存在2个死方法（待修复）
4. ⏳ app_theme.dart：性能可优化（可选）

...
class MatchStatusAdapter extends TypeAdapter<MatchStatus> {
  ...
  MatchStatus read(BinaryReader reader) {
    switch (reader.readByte()) {
      ...
      case 1:
        return MatchStatus.notified;
      case 2:
        return MatchStatus.verifying;
      case 3:
...
class MatchConfidenceAdapter extends TypeAdapter<MatchConfidence> {
  @override
  final int typeId = 15;

  @override
  MatchConfidence read(BinaryReader reader) {
    switch (reader.readByte()) {
      case 0:
  ...
  @override
  void write(BinaryWriter writer, MatchConfidence obj) {
    switch (obj) {
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is MatchConfidenceAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}

class VerificationChoiceAdapter extends TypeAdapter<VerificationChoice> {
  @override
  final int typeId = 16;

  @override
  VerificationChoice read(BinaryReader reader) {
    switch (reader.readByte()) {
      case 0:
        return VerificationChoice.wantContact;
      case 1:
        return VerificationChoice.keepInMemory;
      case 2:
        return VerificationChoice.notMe;
      default:
        return VerificationChoice.wantContact;
    }
  }
  ...
  @override
  void write(BinaryWriter writer, VerificationChoice obj) {
    switch (obj) {
      case VerificationChoice.wantContact:
        writer.writeByte(0);
        break;
      case VerificationChoice.keepInMemory:
        writer.writeByte(1);
        break;
      case VerificationChoice.notMe:
        writer.writeByte(2);
        break;
    }
  }
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is VerificationChoiceAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}
...
class CreditChangeReasonAdapter extends TypeAdapter<CreditChangeReason> {
  @override
  final int typeId = 23;

  @override
  CreditChangeReason read(BinaryReader reader) {
    switch (reader.readByte()) {
      case 0:
        return CreditChangeReason.gpsAnomalyDetected;
      case 1:
        return CreditChangeReason.behaviorAnomalyDetected;
      case 2:
        return CreditChangeReason.goodBehavior;
      case 3:
        return CreditChangeReason.verificationSuccess;
      default:
        return CreditChangeReason.gpsAnomalyDetected;
    }
  }
  ...
  @override
  void write(BinaryWriter writer, CreditChangeReason obj) {
    switch (obj) {
      case CreditChangeReason.gpsAnomalyDetected:
        writer.writeByte(0);
        break;
      case CreditChangeReason.behaviorAnomalyDetected:
        writer.writeByte(1);
        break;
      case CreditChangeReason.goodBehavior:
        writer.writeByte(2);
        break;
      case CreditChangeReason.verificationSuccess:
        writer.writeByte(3);
        break;
    }
  }
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is CreditChangeReasonAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}

...
const List<AboutSectionContent> _staticAboutPageSections = [
  ...
  AboutSectionContent(
    ...
    paragraphs: [
      '每次见面 = 一条新记录。',
      '例如：\n2月8日在地铁看到 TA\n  → 创建记录1，状态“错过”\n\n2月9日又看到 TA\n  → 创建记录2，状态“再遇”\n\n2月10日终于说话了\n  → 创建记录3，状态“邂逅”\n\n2月15日分手了\n  → 创建记录4，状态“别离”\n\n3月1日又遇到了\n  → 创建记录5，状态“重逢”',
      '然后通过“故事线”功能，把这5条记录关联起来，形成完整的时间线。',
...
final List<AboutSectionContent> designDecisionSections = List.unmodifiable([
  ...
  const AboutSectionContent(
    title: '为什么有时候设置了页面切换动画，进入时没有，反而退出时有？',
    paragraphs: [
      '这是 Flutter Web 的已知限制。',
      '在 Web 平台上，页面进入动画经常被跳过或立即完成，但退出动画是正常的。',
      '这不是 bug，而是浏览器和 Flutter Web 渲染机制导致的技术限制。',
      '如果你觉得这很影响体验，可以在设置中选择“无动画”模式。',
      '移动端（Android/iOS）不存在这个问题，进入和退出动画都正常。',
    ],
  ),
  const AboutSectionContent(
    title: '为什么签到系统没有补签功能？',

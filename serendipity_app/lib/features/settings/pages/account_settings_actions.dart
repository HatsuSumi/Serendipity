...
class AccountSettingsActions {
  const AccountSettingsActions._();
  ...
  static void showUpdatePasswordDialog(BuildContext context, WidgetRef ref) {
  ...
  static void showUpdateEmailDialog(BuildContext context, WidgetRef ref) {
  ...
  static void showUpdatePhoneDialog(BuildContext context, WidgetRef ref) {
  ...
  static Future<void> showRecoveryKeyDialog(

...
class SmartNavigator {
  ...
  static void registerCyclicPair(Type pageA, Type pageB) {
    ...
    if (debugMode) {
      print('[SmartNavigator] 注册循环页面对: $pageA ⇄ $pageB');
    }
  }
  ...
  static Future<T?> push<T>({
    ...
    if (debugMode) {
      print('[SmartNavigator] 导航: $currentPageType → $targetPageType');
      print('[SmartNavigator] 使用: ${shouldReplace ? "pushReplacement" : "push"}');
      print('[SmartNavigator] 历史: $_navigationHistory');
    }

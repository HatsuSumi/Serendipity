...
- **代码总行数**：84,026 行（不含空行、注释）
  - Dart：42,072 行（50.1%）
  - JSON：27,648 行（32.9%）
  - TypeScript：9,522 行（11.3%）
...
- **字符总数**：2,811,846 字符（不含注释）
  - Dart：1,382,928 字符（49.2%）
  - JSON：668,404 字符（23.8%）
  - TypeScript：314,459 字符（11.2%）
  - JavaScript：392,601 字符（14.0%）
  - C++：15,306 字符（0.5%）
  - SQL：12,760 字符（0.5%）
  - C：3,231 字符（0.1%）
  - XML：4,268 字符（0.1%）

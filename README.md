...
- **代码总行数**：76,536 行（不含空行、注释）
  - Dart：37,083 行（48.5%）
  - JSON：27,281 行（35.6%）
  - TypeScript：7,560 行（9.9%）
...
- **字符总数**：2,560,836 字符（不含注释）
  - Dart：1,213,738 字符（47.4%）
  - JSON：662,045 字符（25.9%）
  - TypeScript：246,296 字符（9.6%）
  - JavaScript：392,670 字符（15.3%）
  - C++：15,306 字符（0.6%）
  - SQL：12,209 字符（0.5%）
  - C：3,231 字符（0.1%）
  - Kotlin：2,297 字符（0.1%）

...
- **技术栈**：Flutter 3.x + Dart 3.x + Riverpod 2.x + Hive + Node.js + Express + TypeScript + PostgreSQL + 高德地图 API（逆地理编码）
...
- **代码总行数**：79,660 行（不含空行、注释）
  - Dart：39,843 行（50.0%）
  - JSON：27,615 行（34.7%）
  - TypeScript：7,560 行（9.5%）
  - JavaScript：3,382 行（4.2%）
  - C++：442 行（0.6%）
  - SQL：224 行（0.3%）
  - C：105 行（0.1%）
  - Kotlin：84 行（0.1%）
...
- **字符总数**：2,661,294 字符（不含注释）
  - Dart：1,307,601 字符（49.1%）
  - JSON：667,284 字符（25.1%）
  - TypeScript：246,296 字符（9.2%）
  - JavaScript：392,670 字符（14.7%）
  - C++：15,306 字符（0.6%）
  - SQL：12,209 字符（0.5%）
  - C：3,231 字符（0.1%）
  - Kotlin：2,297 字符（0.1%）

...
- **代码总行数**：83,497 行（不含空行、注释）
  - Dart：41,720 行（50.0%）
  - JSON：27,648 行（33.1%）
  - TypeScript：9,345 行（11.2%）
...
- **字符总数**：2,792,838 字符（不含注释）
  - Dart：1,370,588 字符（49.1%）
  - JSON：668,404 字符（23.9%）
  - TypeScript：307,791 字符（11.0%）
  - JavaScript：392,601 字符（14.1%）
  - C++：15,306 字符（0.5%）
  - SQL：12,760 字符（0.5%）
  - C：3,231 字符（0.1%）
  - XML：4,268 字符（0.2%）

...
- **代码总行数**：81,694 行（不含空行、注释）
  - Dart：41,542 行（50.9%）
  - JSON：27,647 行（33.9%）
  - TypeScript：7,758 行（9.5%）
  - JavaScript：3,380 行（4.1%）
  - C++：442 行（0.5%）
  - SQL：196 行（0.2%）
  - C：105 行（0.1%）
  - XML：91 行（0.1%）
...
- **字符总数**：2,729,504 字符（不含注释）
  - Dart：1,363,902 字符（50.0%）
  - JSON：668,336 字符（24.5%）
  - TypeScript：253,474 字符（9.3%）
  - JavaScript：392,601 字符（14.4%）
  - C++：15,306 字符（0.6%）
  - SQL：10,497 字符（0.4%）
  - C：3,231 字符（0.1%）
  - XML：4,268 字符（0.1%）

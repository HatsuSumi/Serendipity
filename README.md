...
- **代码总行数**：86,973 行（不含空行、注释）
  - Dart：43,771 行（50.3%）
  - JSON：27,707 行（31.9%）
  - TypeScript：10,644 行（12.2%）
  - JavaScript：3,380 行（3.9%）
  - C++：442 行（0.5%）
  - SQL：254 行（0.3%）
  - C：105 行（0.1%）
  - XML：93 行（0.1%）
...
- **字符总数**：2,908,797 字符（不含注释）
  - Dart：1,439,385 字符（49.5%）
  - JSON：670,002 字符（23.0%）
  - TypeScript：349,403 字符（12.0%）
  - JavaScript：392,601 字符（13.5%）
  - C++：15,306 字符（0.5%）
  - SQL：14,465 字符（0.5%）
  - C：3,231 字符（0.1%）
  - XML：4,377 字符（0.2%）

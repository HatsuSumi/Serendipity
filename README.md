...
- **代码总行数**：85,631 行（不含空行、注释）
  - Dart：42,947 行（50.2%）
  - JSON：27,707 行（32.4%）
  - TypeScript：10,147 行（11.8%）
...
- **字符总数**：2,866,968 字符（不含注释）
  - Dart：1,414,330 字符（49.3%）
  - JSON：670,002 字符（23.4%）
  - TypeScript：334,334 字符（11.7%）
  - JavaScript：392,601 字符（13.7%）
  - C++：15,306 字符（0.5%）
  - SQL：12,760 字符（0.4%）
  - C：3,231 字符（0.1%）
  - XML：4,377 字符（0.2%）

...
- [下载最新版 Android APK](https://download.hatsusumi.com/serendipity/v1.0.0.apk)
...
- **代码总行数**：99,887 行（不含空行、注释）
  - Dart：47,314 行（47.4%）
  - JSON：32,970 行（33.0%）
  - TypeScript：13,809 行（13.8%）
...
- **字符总数**：3,335,076 字符（不含注释）
  - Dart：1,555,571 字符（46.6%）
  - JSON：853,215 字符（25.6%）
  - TypeScript：456,451 字符（13.7%）

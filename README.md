...
- **代码总行数**：92,652 行（不含空行、注释）
  - Dart：47,308 行（51.1%）
  - JSON：27,374 行（29.5%）
  - TypeScript：13,078 行（14.1%）
...
- **字符总数**：3,106,706 字符（不含注释）
  - Dart：1,555,173 字符（50.1%）
  - JSON：664,824 字符（21.4%）
  - TypeScript：434,863 字符（14.0%）
  - JavaScript：390,766 字符（12.6%）
  - SQL：16,915 字符（0.5%）
  - C++：15,306 字符（0.5%）
  - XML：4,857 字符（0.2%）
  - Java：3,564 字符（0.1%）

...
- **代码总行数**：91,226 行（不含空行、注释）
  - Dart：46,368 行（50.8%）
  - JSON：27,707 行（30.4%）
  - TypeScript：12,325 行（13.5%）
...
- **字符总数**：3,048,137 字符（不含注释）
  - Dart：1,521,766 字符（49.9%）
  - JSON：670,002 字符（22.0%）
  - TypeScript：406,613 字符（13.3%）
  - JavaScript：390,766 字符（12.8%）
  - C++：15,306 字符（0.5%）
  - SQL：16,457 字符（0.5%）
  - C：3,231 字符（0.1%）
  - XML：4,900 字符（0.2%）

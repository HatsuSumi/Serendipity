...
- **代码总行数**：78,758 行（不含空行、注释）
  - Dart：38,941 行（49.4%）
  - JSON：27,615 行（35.1%）
  - TypeScript：7,560 行（9.6%）
  - JavaScript：3,382 行（4.3%）
  - C++：442 行（0.6%）
  - SQL：224 行（0.3%）
  - C：105 行（0.1%）
  - Kotlin：84 行（0.1%）
...
- **字符总数**：2,630,422 字符（不含注释）
  - Dart：1,276,729 字符（48.5%）
  - JSON：667,284 字符（25.4%）
  - TypeScript：246,296 字符（9.4%）
  - JavaScript：392,670 字符（14.9%）
  - C++：15,306 字符（0.6%）
  - SQL：12,209 字符（0.5%）
  - C：3,231 字符（0.1%）
  - Kotlin：2,297 字符（0.1%）

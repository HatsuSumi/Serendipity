...
- **代码总行数**：81,927 行（不含空行、注释）
  - Dart：41,720 行（50.9%）
  - JSON：27,647 行（33.8%）
  - TypeScript：7,813 行（9.5%）
...
- **字符总数**：2,738,352 字符（不含注释）
  - Dart：1,370,567 字符（50.0%）
  - JSON：668,336 字符（24.4%）
  - TypeScript：255,657 字符（9.3%）
  - JavaScript：392,601 字符（14.3%）
  - C++：15,306 字符（0.6%）
  - SQL：10,497 字符（0.4%）
  - C：3,231 字符（0.1%）
  - XML：4,268 字符（0.2%）

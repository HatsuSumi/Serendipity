...
- **代码总行数**：80,890 行（不含空行、注释）
  - Dart：40,929 行（50.6%）
  - JSON：27,614 行（34.1%）
  - TypeScript：7,635 行（9.4%）
  - JavaScript：3,380 行（4.2%）
  - C++：442 行（0.5%）
  - SQL：224 行（0.3%）
  - C：105 行（0.1%）
  - Kotlin：84 行（0.1%）
...
- **字符总数**：2,701,396 字符（不含注释）
  - Dart：1,342,944 字符（49.7%）
  - JSON：667,260 字符（24.7%）
  - TypeScript：248,688 字符（9.2%）
  - JavaScript：392,601 字符（14.5%）
  - C++：15,306 字符（0.6%）
  - SQL：12,209 字符（0.4%）
  - C：3,231 字符（0.1%）
  - Kotlin：2,297 字符（0.1%）

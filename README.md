...
- **代码总行数**：87,342 行（不含空行、注释）
  - Dart：43,992 行（50.4%）
  - JSON：27,707 行（31.7%）
  - TypeScript：10,793 行（12.3%）
...
- **字符总数**：2,921,590 字符（不含注释）
  - Dart：1,446,935 字符（49.5%）
  - JSON：670,002 字符（22.9%）
  - TypeScript：354,666 字符（12.1%）
  - JavaScript：392,601 字符（13.4%）
  - C++：15,306 字符（0.5%）
  - SQL：14,465 字符（0.5%）
  - C：3,231 字符（0.1%）
  - XML：4,377 字符（0.2%）

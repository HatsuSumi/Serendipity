...
- **代码总行数**：84,364 行（不含空行、注释）
  - Dart：42,269 行（50.1%）
  - JSON：27,648 行（32.8%）
  - TypeScript：9,621 行（11.4%）
...
- **字符总数**：2,823,448 字符（不含注释）
  - Dart：1,389,361 字符（49.2%）
  - JSON：668,404 字符（23.7%）
  - TypeScript：317,598 字符（11.2%）
  - JavaScript：392,601 字符（13.9%）
  - C++：15,306 字符（0.5%）
  - SQL：12,760 字符（0.5%）
  - C：3,231 字符（0.1%）
  - XML：4,268 字符（0.2%）

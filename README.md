...
- **代码总行数**：100,709 行（不含空行、注释）
  - Dart：48,070 行（47.7%）
  - JSON：32,970 行（32.7%）
  - TypeScript：13,835 行（13.7%）
...
- **字符总数**：3,363,779 字符（不含注释）
  - Dart：1,581,943 字符（47.0%）
  - JSON：853,215 字符（25.4%）
  - TypeScript：457,284 字符（13.6%）
  - JavaScript：391,216 字符（11.6%）
  - CSS：17,733 字符（0.5%）
  - C++：15,306 字符（0.5%）
  - SQL：17,047 字符（0.5%）
  - C：3,231 字符（0.1%）

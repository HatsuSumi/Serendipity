...
- **代码总行数**：89,207 行（不含空行、注释）
  - Dart：44,460 行（49.8%）
  - JSON：27,707 行（31.1%）
  - TypeScript：12,226 行（13.7%）
...
- **字符总数**：2,990,778 字符（不含注释）
  - Dart：1,466,035 字符（49.0%）
  - JSON：670,002 字符（22.4%）
  - TypeScript：405,854 字符（13.6%）
  - JavaScript：390,766 字符（13.1%）
  - C++：15,306 字符（0.5%）
  - SQL：15,200 字符（0.5%）
  - C：3,231 字符（0.1%）
  - XML：4,377 字符（0.1%）

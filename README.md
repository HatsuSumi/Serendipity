...
- **代码总行数**：88,622 行（不含空行、注释）
  - Dart：44,364 行（50.0%）
  - JSON：27,707 行（31.3%）
  - TypeScript：11,745 行（13.2%）
...
- **字符总数**：2,968,531 字符（不含注释）
  - Dart：1,462,377 字符（49.3%）
  - JSON：670,002 字符（22.6%）
  - TypeScript：387,909 字符（13.1%）
  - JavaScript：390,766 字符（13.2%）
  - C++：15,306 字符（0.5%）
  - SQL：14,556 字符（0.5%）
  - C：3,231 字符（0.1%）
  - XML：4,377 字符（0.1%）

...
- **代码总行数**：87,628 行（不含空行、注释）
  - Dart：44,286 行（50.5%）
  - JSON：27,707 行（31.6%）
  - TypeScript：10,832 行（12.4%）
  - JavaScript：3,333 行（3.8%）
  - C++：442 行（0.5%）
  - SQL：254 行（0.3%）
  - C：105 行（0.1%）
  - XML：93 行（0.1%）
...
- **字符总数**：2,933,436 字符（不含注释）
  - Dart：1,459,530 字符（49.8%）
  - JSON：670,002 字符（22.8%）
  - TypeScript：355,752 字符（12.1%）
  - JavaScript：390,766 字符（13.3%）
  - C++：15,306 字符（0.5%）
  - SQL：14,465 字符（0.5%）
  - C：3,231 字符（0.1%）
  - XML：4,377 字符（0.2%）

...
- **代码总行数**：90,469 行（不含空行、注释）
  - Dart：45,611 行（50.4%）
  - JSON：27,707 行（30.6%）
  - TypeScript：12,325 行（13.6%）
...
- **字符总数**：3,026,207 字符（不含注释）
  - Dart：1,499,836 字符（49.6%）
  - JSON：670,002 字符（22.1%）
  - TypeScript：406,613 字符（13.4%）
  - JavaScript：390,766 字符（12.9%）
  - C++：15,306 字符（0.5%）
  - SQL：16,457 字符（0.5%）
  - C：3,231 字符（0.1%）
  - XML：4,900 字符（0.2%）
